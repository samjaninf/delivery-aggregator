      ...
      >
        <b-card class="p-1">
          <form @submit.prevent="handleSubmit">
            ...
            <b-form-group
              label="Email"
              description="Assicurati di usare una email unica,"
            >
              <b-form-input
                type="email"
            ...
            <b-form-group
              label="Password"
              description="Inserisci una password per modificare quella esistente."
            >
              <b-form-input
                type="password"
            ...
            <b-form-group
              label="Firebase Registration ID"
              v-if="editing"
            >
              <b-form-input
                type="text"
                class="form-control"
                v-model="user.fb_device_id"
                disabled
              ></b-form-input>
            </b-form-group>
