<template>
  <b-container class="mt-4">
    <router-link to="/" class="mt-4 d-block" :style="{ marginBottom: '3em' }">
      <i class="fas fa-chevron-left mr-2"></i> Torna a <strong>Delivery Aggregator</strong>
    </router-link>

    <h1>Informativa sulla Privacy</h1>

    <p>Data di entrata in vigore: November 01, 2018</p>

    <p>Delivery Aggregator ("noi" o "nostro") gestisce il sito web http://deliveryaggregator.com e l'applicazione Delivery Aggregator per dispositivi mobili (in appresso il "Servizio").</p>
    ...
    <ul>
      <li>
        ...
        <p>Servizio significa il http://deliveryaggregator.com sito web e l'applicazione per dispositivi mobili Delivery Aggregator gestiti da Delivery Aggregator</p>
      </li>
      <li>
    ...
    <p>Possiamo anche raccogliere informazioni che il browser invia ogni volta che si visita il nostro Servizio o quando si accede al servizio o tramite un dispositivo mobile ("Dati di utilizzo").</p>
    <p>Questi Dati di utilizzo possono includere informazioni quali l'indirizzo del protocollo Internet del computer (ad es. Indirizzo IP), il tipo di browser, la versione del browser, le pagine del nostro servizio che si visita, l'ora e la data della visita, il tempo trascorso su tali pagine, identificatore unico del dispositivo e altri dati diagnostici.</p>
    ...
    <h2>Uso dei dati</h2>
    <p>Delivery Aggregator utilizza i dati raccolti per vari scopi:</p>
    <ul>
    ...
    <ul>
      <li>Tramite e-mail: comunicazione.moschella@gmail.com</li>
    </ul>
  </b-container>
</template>