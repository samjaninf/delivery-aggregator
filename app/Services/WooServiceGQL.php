...
class WooServiceGQL
{
    ...
    public function paginatorInfo($client, $count, $page, $result)
    {
     ...
     */
    public function orders($store, $count = 20, $page = 1)
    {
        ...
        ->values()
            ->map(function ($order) {
                ...
                return [
                    ...
                    'delivery_date' => \Carbon\Carbon::createFromTimestamp($slot_from ?? -1),
                    'delivery_date_end' => \Carbon\Carbon::createFromTimestamp($slot_to ?? -1),
                    'items' => $items ?? [],
